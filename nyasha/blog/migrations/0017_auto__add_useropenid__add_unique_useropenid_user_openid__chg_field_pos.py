...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_useropenid', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='d', max_length=1)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('openid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['loginza.OpenID'])),
        ))
        db.send_create_signal('blog', ['UserOpenID'])

        # Adding unique constraint on 'UserOpenID', fields ['user', 'openid']
        db.create_unique('blog_useropenid', ['user_id', 'openid_id'])

        # Changing field 'Post.from_client'
        db.alter_column('blog_post', 'from_client', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Comment.from_client'
        db.alter_column('blog_comment', 'from_client', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # Removing unique constraint on 'UserOpenID', fields ['user', 'openid']
        db.delete_unique('blog_useropenid', ['user_id', 'openid_id'])

        # Deleting model 'UserOpenID'
        db.delete_table('blog_useropenid')

        # Changing field 'Post.from_client'
        db.alter_column('blog_post', 'from_client', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Comment.from_client'
        db.alter_column('blog_comment', 'from_client', self.gf('django.db.models.fields.CharField')(max_length=256))
