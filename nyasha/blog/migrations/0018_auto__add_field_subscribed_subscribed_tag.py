...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscribed.subscribed_tag'
        db.add_column('blog_subscribed', 'subscribed_tag', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subscribed_tag', null=True, to=orm['blog.Tag']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscribed.subscribed_tag'
        db.delete_column('blog_subscribed', 'subscribed_tag_id')
