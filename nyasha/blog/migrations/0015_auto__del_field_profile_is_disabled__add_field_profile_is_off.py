...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.is_off'
        db.add_column('blog_profile', 'is_off', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.is_off'
        db.delete_column('blog_profile', 'is_off')
