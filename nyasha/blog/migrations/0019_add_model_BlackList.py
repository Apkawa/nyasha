...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_blacklist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='me_blacklist', to=orm['auth.User'])),
            ('blacklisted_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='blacklisted_user', null=True, to=orm['auth.User'])),
            ('blacklisted_tag', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='blacklisted_tag', null=True, to=orm['blog.Tag'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('blog', ['BlackList'])


    def backwards(self, orm):
        
        # Deleting model 'BlackList'
        db.delete_table('blog_blacklist')
