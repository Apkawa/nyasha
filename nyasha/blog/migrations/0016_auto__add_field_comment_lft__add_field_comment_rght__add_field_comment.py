...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.lft'
        db.add_column('blog_comment', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Comment.rght'
        db.add_column('blog_comment', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Comment.tree_id'
        db.add_column('blog_comment', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Comment.mptt_level'
        db.add_column('blog_comment', 'mptt_level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.lft'
        db.delete_column('blog_comment', 'lft')

        # Deleting field 'Comment.rght'
        db.delete_column('blog_comment', 'rght')

        # Deleting field 'Comment.tree_id'
        db.delete_column('blog_comment', 'tree_id')

        # Deleting field 'Comment.mptt_level'
        db.delete_column('blog_comment', 'mptt_level')
